...
import { SendTransactionOptions, TransactionMiddleware } from '../../src/types.js';
import { LogsSubscription, NewPendingTransactionsSubscription, NewHeadsSubscription, SyncingSubscription } from '../../src/web3_subscriptions.js';
...
export declare class Web3Eth extends Web3Context<Web3EthExecutionAPI, RegisteredSubscription> {
     ...
     * ```
     */
    sendSignedTransaction<ReturnFormat extends DataFormat = typeof DEFAULT_RETURN_FORMAT>(transaction: Bytes, returnFormat?: ReturnFormat, options?: SendTransactionOptions): import("web3-core").Web3PromiEvent<import("web3-types").TransactionReceipt, import("../../src/types.js").SendSignedTransactionEvents<ReturnFormat>>;
    /**
