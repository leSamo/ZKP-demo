...
import { Web3EthInterface } from '../../src/types.js';
export declare class Web3<CustomRegisteredSubscription extends {
    ...
    static onNewProviderDiscovered: (callback: (providerEvent: import("../../src/web3_eip6963.js").EIP6963AnnounceProviderEvent<unknown>) => void) => void;
    static modules: {
